"""Directional flip confirmation shared by live execution and research replay."""
...
from platform_v2.futures.domain.entry_timing import ACTIONABLE_DIRECTIONS, normalize_direction
