...
from platform_v2.spot.services.ops.main_cycle.guards import MainCycleGuardService


def test_cycle_marker_uses_runtime_state_without_json_files() -> None:
    service = MainCycleGuardService()
    with patch(
        "platform_v2.spot.services.ops.main_cycle.guards.read_runtime_state",
    ...
    with patch("platform_v2.spot.services.ops.main_cycle.guards.write_runtime_state") as write_state:
